...
class Q_DECL_EXPORT QHotkey : public QObject
{
	Q_OBJECT
	//! @private
...
public:
	...
	class Q_DECL_EXPORT NativeShortcut {
	public:
		//! The native keycode
		quint32 key;
...
QHOTKEY_HASH_SEED Q_DECL_EXPORT qHash(QHotkey::NativeShortcut key);
QHOTKEY_HASH_SEED Q_DECL_EXPORT qHash(QHotkey::NativeShortcut key, QHOTKEY_HASH_SEED seed);

Q_DECL_EXPORT Q_DECLARE_LOGGING_CATEGORY(logQHotkey)
